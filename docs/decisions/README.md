...
| [ADR-008](telemetry/ADR-008-govern-hook-mappings-as-a-versioned-telemetry-contract.md)            | Govern hook mappings as a versioned telemetry contract                          | `telemetry`    | accepted | 2026-05-20 |
| [ADR-009](telemetry/ADR-009-catalog-agent-execution-profiles-and-instances.md)                    | Catalog agent execution profiles, observations, and instances                   | `telemetry`    | accepted | 2026-05-20 |
